...
const Page7 = () => {
    ...
    return (
        <div className={`absolute left-0 h-full w-full flex flex-col justify-center items-center px-11 bg-gradient-to-r from-gray-100 from-80% to-gray-300 ${paper}`}>
                ...
                <form onSubmit={handleSubmit} className="mt-7 pt-2 flex flex-col w-full h-80 bg-white rounded-lg mx-auto">
                    <label>
                        <input
                            ...
                            className="h-8 w-5/6 bg-gray-100 pl-2 mx-5 my-2 border"
                        />
                    </label>
                    <label>
                        <input
                            ...
                            className="h-8 w-5/6 bg-gray-100 mx-5 my-2 pl-2 border"
                        />
                    </label>
                    <label>
                        <textarea
                            ...
                            className="h-32 w-5/6 bg-gray-100 mx-5 my-2 pl-2 border"
                        />
                    </label>
